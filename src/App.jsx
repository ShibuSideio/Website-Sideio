...
// Base64 encoded image data for the 'S' logo
const logoData = "data:image/png;base64,";
...
// --- COMPONENT: THE STRATEGY LOGIC AUDITOR (Modern Enterprise UI) ---
const ShadowAuditorModal = ({ isOpen, onClose }) => {
  ...
  const generatePDF = (content) => {
    ...
    // Logo
    doc.addImage(logoData, 'PNG', 20, 15, 30, 15);

    // Header
    doc.setTextColor(16, 185, 129); // SideIO Emerald
    doc.setFont("helvetica", "bold");
    doc.setFontSize(22);
    doc.text("SIDEIO STRATEGY AUDIT", 20, 45);
    
    doc.setFontSize(10);
    doc.setTextColor(100, 100, 100); // Gray
    doc.text("CONFIDENTIAL DOSSIER | GENERATED BY SIDEIO LOGIC CORE", 20, 53);
    
    doc.setDrawColor(200, 200, 200);
    doc.line(20, 58, 190, 58);

    // Content Body
    doc.setFont("courier", "normal"); // Keep content in courier for "audit" feel
    doc.setFontSize(11);
  ...
  return (
    <AnimatePresence>
      <motion.div 
        ...
        animate={{ opacity: 1 }} 
        exit={{ opacity: 0 }} 
        className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-md font-sans"
      >
        <motion.div 
          initial={{ scale: 0.95, opacity: 0, y: 20 }} 
          animate={{ scale: 1, opacity: 1, y: 0 }} 
          exit={{ scale: 0.95, opacity: 0, y: 20 }}
          className="w-full h-[100dvh] md:h-[85vh] md:max-w-4xl bg-white md:rounded-2xl shadow-2xl overflow-hidden flex flex-col border border-gray-100"
        >
          {/* Header */}
          <div className="bg-white px-6 py-5 flex items-center justify-between border-b border-gray-100 shadow-sm shrink-0 relative z-10">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="w-2.5 h-2.5 bg-emerald-500 rounded-full"></div>
                <div className="absolute top-0 left-0 w-2.5 h-2.5 bg-emerald-500 rounded-full animate-ping opacity-75"></div>
              </div>
              <div>
                <h3 className="text-gray-900 font-extrabold tracking-tight text-sm uppercase">Strategy Logic Auditor</h3>
                <p className="text-[10px] text-gray-400 font-medium">SideIO Intelligence Unit • Active</p>
              </div>
            </div>
            
            <div className="flex items-center gap-4">
                <div className={`hidden md:flex items-center gap-2 text-xs font-bold px-3 py-1.5 rounded-full ${timeLeft < 20 ? 'bg-red-50 text-red-600' : 'bg-gray-50 text-gray-500'}`}>
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span>{timeLeft}s REMAINING</span>
                </div>

                <button onClick={onClose} className="text-gray-400 hover:text-gray-900 transition p-2 hover:bg-gray-100 rounded-full">
          ...
          {/* Chat Stream */}
          <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 bg-gray-50/50 scrollbar-thin scrollbar-thumb-gray-200">
            {messages.map((msg, idx) => (
              <div key={idx} className={`flex flex-col ${msg.role === 'user' ? 'items-end' : 'items-start'}`}>
                
                {/* Message Bubble */}
                <div className={`max-w-[90%] md:max-w-[80%] p-5 md:p-6 rounded-2xl text-sm md:text-[15px] leading-7 shadow-sm ${
                  msg.role === 'user' 
                    ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-tr-none shadow-emerald-100' 
                    : 'bg-white text-gray-700 border border-gray-100 rounded-tl-none'
                }`}>
                  <div className="whitespace-pre-wrap font-medium">{msg.text}</div>
                </div>

                {/* PDF DOWNLOAD CARD (If Final Report) */}
                {msg.role === 'ai' && isReport(msg.text) && (
                    <motion.button 
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        onClick={() => generatePDF(msg.text)}
                        className="mt-4 group flex items-center gap-4 bg-white border border-gray-200 hover:border-emerald-500 p-4 rounded-xl shadow-sm hover:shadow-md transition-all cursor-pointer w-full max-w-sm text-left"
                    >
                        ...
                        <div>
                            <p className="font-bold text-gray-900 text-sm group-hover:text-emerald-700">Download Official Audit</p>
                            <p className="text-xs text-gray-400">Secure PDF Format • 1.2 MB</p>
                        </div>
                    </motion.button>
                )}
              </div>
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-white px-5 py-4 rounded-2xl rounded-tl-none border border-gray-100 shadow-sm flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-400 font-semibold ml-2">ANALYZING...</span>
                </div>
              </div>
            )}
          ...
          {/* Input Console */}
          <div className="bg-white border-t border-gray-100 p-4 md:p-6 shrink-0 relative z-20">
            {isSessionExpired ? (
                <div className="text-center py-6 bg-red-50 border border-red-100 rounded-2xl">
                    <p className="font-bold text-gray-900 mb-1">Session Closed</p>
                    <p className="text-xs text-gray-500 mb-4">High-value strategy requires decisiveness.</p>
                    <button 
                        onClick={() => { setIsSessionExpired(false); setTimeLeft(90); setMessages([{role: 'ai', text: "Session Restored. State your priority."}]); }}
                        className="px-6 py-2.5 text-xs font-bold uppercase tracking-wider bg-white border border-red-200 text-red-600 hover:bg-red-50 rounded-full transition-all shadow-sm"
                    >
                        Request Re-connection
                    </button>
                </div>
            ) : (
                <form onSubmit={handleSend} className="relative flex items-center shadow-lg rounded-2xl">
                    <input 
                        type="text" 
                        value={input}
                        onChange={(e) => setInput(e.target.value)}
                        placeholder="Type your strategic priority..." 
                        className="w-full bg-white text-gray-900 pl-6 pr-16 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all font-medium placeholder-gray-400 text-base"
                        autoFocus
                    />
                    <button 
                        type="submit" 
                        disabled={isLoading}
                        className="absolute right-2 bg-emerald-600 text-white p-2.5 rounded-xl hover:bg-emerald-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </button>
                </form>
            )}
            <p className="text-center text-[10px] text-gray-300 mt-4 font-medium uppercase tracking-widest">Confidential Strategy Channel</p>
          </div>
        </motion.div>
      </motion.div>
    </AnimatePresence>
